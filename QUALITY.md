...
> **The diagnosis below is stale** — 300 commits since the diagnosis; re-run diagnose before trusting it.
...
- [ ] **P3 drain** — 51 findings across 5 rules
  - [ ] `ruff:PLC1901` — 2 left
  - [ ] `ruff:RUF105` — 6 left
  - [ ] `ruff:SLF001` — 8 left
