...
still includes the mypy backlog alongside the last known Ruff ceiling. If an analyzer cannot run,
the report names why rather than rendering an unmeasured count as zero.
