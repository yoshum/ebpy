...
| --- | --- | --- |
| `append_log` | src/ebpy/state.py:234 |  |
| `apply_rule_counts` | src/ebpy/state.py:255 |  |
| `area_of` | src/ebpy/lint_report.py:21 |  |
| `assess_freshness` | src/ebpy/freshness.py:45 |  |
| `baseline_path` | src/ebpy/baseline.py:43 |  |
...
| `cells_of` | src/ebpy/baseline.py:114 |  |
...
| `find_regressions` | src/ebpy/state.py:282 | The gate. |
...
| `improvements` | src/ebpy/state.py:295 |  |
...
| `log_of_kind` | src/ebpy/state.py:240 |  |
| `main` | src/ebpy/cli.py:227 |  |
...
| `next_baseline` | src/ebpy/state.py:249 |  |
| `parse_ruff_json` | src/ebpy/ruff_runner.py:67 |  |
| `parse_suppressions` | src/ebpy/baseline.py:30 |  |
| `prune_cells` | src/ebpy/baseline.py:132 | Lower every cell to what still exists, and never raise one — the only sanctioned way for the ceiling to fall. |
| `read_ceiling` | src/ebpy/baseline.py:64 |  |
| `read_ceiling_artifacts` | src/ebpy/ceiling_artifacts.py:98 | Read and classify both files without inferring missing contract data. |
| `read_cells` | src/ebpy/baseline.py:110 |  |
| `read_ledger` | src/ebpy/state.py:204 |  |
| `read_sources` | src/ebpy/facts.py:82 |  |
| `read_state` | src/ebpy/state.py:216 |  |
| `read_suppression_total` | src/ebpy/baseline.py:106 |  |
| `read_suppressions` | src/ebpy/baseline.py:98 |  |
...
| `set_counter` | src/ebpy/state.py:270 |  |
| `split_against_baseline` | src/ebpy/baseline.py:144 | Divide today's violations into (new, grandfathered) per rule. |
| `state_from_dict` | src/ebpy/state.py:135 |  |
| `state_path` | src/ebpy/state.py:59 |  |
| `state_to_dict` | src/ebpy/state.py:173 |  |
| `total_of` | src/ebpy/baseline.py:166 |  |
| `total_violations` | src/ebpy/state.py:303 |  |
...
| `with_diagnosis` | src/ebpy/state.py:227 |  |
| `with_phase` | src/ebpy/state.py:244 |  |
| `write_cells` | src/ebpy/baseline.py:121 |  |
| `write_quality_file` | src/ebpy/quality_file.py:27 |  |
| `write_state` | src/ebpy/state.py:220 |  |

## src/ebpy/commands

| Helper | Where | What it does |
| --- | --- | --- |
| `is_log_kind` | src/ebpy/commands/log.py:27 |  |
...
| `run_diagnose` | src/ebpy/commands/diagnose.py:24 |  |
| `run_freeze` | src/ebpy/commands/freeze.py:86 |  |
| `run_install` | src/ebpy/commands/install.py:444 |  |
| `run_log` | src/ebpy/commands/log.py:31 | `deferred` is the one that earns its keep: a refactor consciously not made, stamped with the commit it was seen at, so the next session can tell whether the observation still describes the code. |
| `run_next` | src/ebpy/commands/next_command.py:29 |  |
| `run_prune` | src/ebpy/commands/prune.py:35 | `freeze` pins whatever exists today, so running it a second time would grandfather violations added since. |
| `run_report` | src/ebpy/commands/report.py:52 |  |
| `run_secrets` | src/ebpy/commands/secrets.py:35 |  |
| `run_skills_install` | src/ebpy/commands/install.py:332 |  |
| `run_status` | src/ebpy/commands/status.py:22 |  |
